...
//!
//! Called by core HTTP handlers in `virtues-core/src/api/auth.rs` (Phase 3) and by
...
pub use proxy::{proxy_exchange, proxy_refresh, proxy_url, ProxyExchangeResponse};
...
pub use vault::{
    ...
    finalize_self_issued_bearer, generate_bearer, mark_credential_status,
