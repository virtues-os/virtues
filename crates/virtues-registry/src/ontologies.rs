    ...
    vec![
        ...
        OntologyDescriptor {
            ...
            embedding: Some(EmbeddingConfig {
                ...
                preview_sql: "COALESCE(t.merchant_name, t.description) || ' - $' || CAST(ROUND(ABS(t.amount) / 100.0, 2) AS TEXT) || ' on ' || t.occurred_at::text",
                author_sql: None,
                timestamp_sql: "t.occurred_at",
                embed_where: None,
            }),
            ...
            day_source: Some(DaySourceConfig {
                ...
                preview_sql: "'$' || CAST(ROUND(ABS(t.amount) / 100.0, 2) AS TEXT)",
                id_sql: "t.id",
                extra_where: None,
                use_date_filter: false,
            }),
