...
| [article-resolution-plan.md](article-resolution-plan.md) | Planned | Every subject has an article, and one process writes and maintains all of them. A first draft is one-shot; a revision is agentic, in the applet runner's never-used agent phase. Supersedes wiki-rungs-plan.md and overrules wiki-plan §10: ownership never flips. |
...
| [wiki-plan.md](wiki-plan.md) | Partly built | The personal wikipedia: every subject has one page, prose written from the record with citations, and an article is a page so the CRDT, history and marginalia come for free. Built to the day and the entity article. **Its §10 one-pen rule is overruled** by [article-resolution-plan.md](article-resolution-plan.md). |
