...
| File | Role |
|------|------|
| `packages/virtues-registry/src/ontologies.rs` | Ontology registry: source configs |
| `core/src/api/wiki.rs` | Day data API: sources, events, day CRUD |
| `core/src/api/day_summary.rs` | Tollbooth LLM call, event parsing |
| `core/src/dayline/autonomic_scoring.rs` | Context-gated HR/HRV autonomic scoring |
