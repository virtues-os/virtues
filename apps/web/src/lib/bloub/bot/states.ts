...
export const STATES: StateDef[] = [
...

  {
    ...
    blinkIn: false,
    pose: (t) => {
      // Local divergence from upstream bloub (single bouncing dot): the doze
      // is the virtues mark — three dots in a therefore sign (∴) breathing in
      // a slow ripple. The body BECOMES the apex dot so the collapse morph
