...
INSERT OR IGNORE INTO data_location_visit (
    ...
    '2026-02-13T21:00:00Z', '2026-02-13T21:45:00Z', 45,
...
INSERT OR IGNORE INTO data_location_visit (
    ...
    '2026-02-13T21:45:00Z', '2026-02-13T22:15:00Z', 30,
...
INSERT OR IGNORE INTO data_location_visit (
    ...
    '2026-02-13T22:45:00Z', '2026-02-13T23:30:00Z', 45,
    'demo_lv_006', 'data_location_visit', 'demo'
);

-- (Evening location visits omitted — partial day)
...
('steps_demo_14', 980, '2026-02-14T18:45:00Z', 'demo_steps_014', 'data_health_steps', 'demo');
...
('hr_demo_12', 92, '2026-02-13T23:35:00Z', 'demo_hr_012', 'data_health_heart_rate', 'demo');
...
I think I want to put in an offer. I need to sleep on it. But I think this is the one.',
    'en', 180,
    '2026-02-13T21:50:00Z', '2026-02-13T21:53:00Z',
...
('lp_demo_07', 30.2672, -97.7431, 10.0, '2026-02-13T20:30:00Z', 'demo_lp_007', 'data_location_point', 'demo'),
('lp_demo_08', 30.2600, -97.7480, 12.0, '2026-02-13T20:40:00Z', 'demo_lp_008', 'data_location_point', 'demo'),
('lp_demo_09', 30.2520, -97.7530, 8.0, '2026-02-13T20:50:00Z', 'demo_lp_009', 'data_location_point', 'demo'),
('lp_demo_10', 30.2480, -97.7580, 5.0, '2026-02-13T21:00:00Z', 'demo_lp_010', 'data_location_point', 'demo'),
...
-- Drive: Jo's Coffee → Home (16:15-16:45 CST = 22:15-22:45 UTC)
('lp_demo_j2h_01', 30.2510, -97.7490, 8.0, '2026-02-13T22:15:00Z', 'demo_lp_j2h_001', 'data_location_point', 'demo'),
('lp_demo_j2h_02', 30.2750, -97.7270, 10.0, '2026-02-13T22:30:00Z', 'demo_lp_j2h_002', 'data_location_point', 'demo'),
('lp_demo_j2h_03', 30.2989, -97.7055, 5.0, '2026-02-13T22:45:00Z', 'demo_lp_j2h_003', 'data_location_point', 'demo');
...
INSERT OR IGNORE INTO wiki_entity_refs (id, entity_type, entity_id, source_table, source_id, role, timestamp) VALUES
...
('eref_txn_lunch_maya', 'person', 'person_demo_maya', 'data_communication_transcription', 'txn_demo_lunch', 'speaker', '2026-02-13T17:45:00Z');
