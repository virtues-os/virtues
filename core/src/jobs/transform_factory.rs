...
impl TransformFactory {
    ...
    pub fn create(
        ...
        match (source_table, target_table) {
            ...
            // Note: Location clustering (location_point -> location_visit) is now handled
            // by entity_resolution/places.rs in the narrative primitive pipeline
            ...
            _ => Err(Error::InvalidInput(format!(
                "Unknown transform mapping: {} -> {}. \
                 Check jobs/transform_factory.rs for supported transforms.",
