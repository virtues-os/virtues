...
//!
//! Transforms raw chat messages from stream_virtues_ai_chat into the normalized
//! knowledge_ai_conversation ontology table.
//!
//! ## Data Flow
//!
//! - **Source**: `stream_virtues_ai_chat` (JSONL in S3, written by AppChatExportStream)
//! - **Target**: `data.knowledge_ai_conversation` (normalized ontology table)
//! - **Checkpoint**: `virtues_to_chat_conversation` (tracks S3 read progress)
//!
//! ## Naming Context
//!
//! The transform registry maps:
//! - Stream name `app_export` → Stream table `stream_virtues_ai_chat` (via normalize_stream_name)
//! - Stream table `stream_virtues_ai_chat` → Ontology `knowledge_ai_conversation` (this transform)
//!
//! ## Transform Logic
//!
...
impl OntologyTransform for ChatConversationTransform {
    ...
    async fn transform(
        ...
        let checkpoint_key = "virtues_to_chat_conversation";
        ...
        tracing::debug!(
            ...
            "Fetched Virtues AI Chat batches (hot path)"
        );
...
// Self-registration
struct ChatConversationTransformRegistration;

impl TransformRegistration for ChatConversationTransformRegistration {
...
inventory::submit! {
    &ChatConversationTransformRegistration as &dyn TransformRegistration
}
...
mod tests {
    ...
    fn test_transform_metadata() {
        ...
        assert_eq!(transform.source_table(), "stream_virtues_ai_chat");
