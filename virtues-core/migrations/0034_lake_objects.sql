...
--
-- (0033 is not missing: it is `stories_foundations`, which lives on the
-- feat/stories-foundations branch and has not merged here yet. Numbered 0034 to
-- avoid colliding with it. The repo already tolerates gaps — 0023-0025 are
-- absent — but when stories merges, apply 0033 before this on a fresh box.)
--
