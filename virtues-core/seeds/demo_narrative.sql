...
INSERT INTO wiki_events (
    ...
    'Coffee and Slack', 'Office', '["app_usage", "message"]', FALSE, FALSE,
...
INSERT INTO wiki_events (
    ...
    'Afternoon work', 'Office', '["app_usage"]', FALSE, FALSE,
...
INSERT INTO wiki_events (
    ...
    'Design review', 'Office', '["calendar", "message"]', FALSE, FALSE,
...
INSERT INTO wiki_events (
    ...
    'Focused work', 'Office', '["app_usage"]', FALSE, FALSE,
...
INSERT INTO wiki_events (
    ...
    'Evening run', 'Mueller Trails', '["steps", "workout"]', FALSE, FALSE,
...
INSERT INTO wiki_events (
    ...
    'Morning walk', 'Mueller Trails', '["steps"]', FALSE, FALSE,
...
INSERT INTO wiki_events (
    ...
    'Cooking', 'Home', '["app_usage"]', FALSE, FALSE,
...
INSERT INTO wiki_events (
    ...
    'Phone call with Mom', 'Home', '["transcription"]', FALSE, FALSE,
...
INSERT INTO wiki_events (
    ...
    'Walk at Lady Bird Lake', 'Lady Bird Lake', '["steps", "location_visit"]', FALSE, FALSE,
...
INSERT INTO wiki_events (
    ...
    'Afternoon at home', 'Home', '["app_usage"]', FALSE, FALSE,
...
INSERT INTO wiki_events (
    ...
    'Errands and reading', 'Home', '["app_usage"]', FALSE, FALSE,
...
INSERT INTO wiki_events (
    ...
    'Morning run', 'Mueller Trails', '["steps", "workout"]', FALSE, FALSE,
...
INSERT INTO wiki_events (
    ...
    'Morning work', 'Office', '["app_usage"]', FALSE, FALSE,
...
INSERT INTO wiki_events (
    ...
    'WFH afternoon', 'Home', '["app_usage"]', FALSE, FALSE,
...
INSERT INTO wiki_events (
    ...
    'Evening walk', 'Mueller Trails', '["steps"]', FALSE, FALSE,
...
INSERT INTO wiki_events (
    ...
    'Errands', NULL, '["location_visit"]', FALSE, FALSE,
...
INSERT INTO wiki_events (
    ...
    'Home break', 'Home', '["app_usage"]', FALSE, FALSE,
...
INSERT INTO wiki_events (
    ...
    'Coffee at Jo''s', 'Jo''s Coffee', '["location_visit"]', FALSE, FALSE,
...
INSERT INTO wiki_events (
    ...
    'Lunch', 'Office', '["location_visit"]', FALSE, FALSE,
...
INSERT INTO wiki_events (
    ...
    'Dinner and reading', 'Home', '["app_usage"]', FALSE, FALSE,
...
INSERT INTO wiki_events (
    ...
    'Standup and design review', 'Office', '["calendar", "message", "transcription"]', FALSE, FALSE,
...
INSERT INTO wiki_events (
    ...
    'Dinner and TV', 'Home', '["app_usage"]', FALSE, FALSE,
...
INSERT INTO wiki_events (
    ...
    'Walk', 'Mueller Trails', '["steps"]', FALSE, FALSE,
...
INSERT INTO wiki_events (
    ...
    'Slow morning', 'Home', '["app_usage"]', FALSE, FALSE,
...
INSERT INTO wiki_events (
    ...
    'Lady Bird Lake walk', 'Lady Bird Lake', '["steps", "location_visit"]', FALSE, FALSE,
...
INSERT INTO wiki_events (
    ...
    'Errands and lunch', NULL, '["location_visit"]', FALSE, FALSE,
...
INSERT INTO wiki_events (
    ...
    'Reading', 'Home', '["app_usage"]', FALSE, FALSE,
...
INSERT INTO wiki_events (
    ...
    'Dinner and movie', 'Home', '["app_usage"]', FALSE, FALSE,
...
INSERT INTO wiki_events (
    ...
    'Cooking', 'Home', '["location_visit"]', FALSE, FALSE,
...
INSERT INTO wiki_events (
    ...
    'Reading and browsing', 'Home', '["app_usage"]', FALSE, FALSE,
...
INSERT INTO wiki_events (
    ...
    'Dinner and wind down', 'Home', '["app_usage"]', FALSE, FALSE,
...
INSERT INTO wiki_events (
    ...
    'Onboarding audit', 'Office', '["app_usage"]', FALSE, FALSE,
...
INSERT INTO wiki_events (
    ...
    'Evening walk and dinner', 'Home', '["steps", "app_usage"]', FALSE, FALSE,
...
INSERT INTO wiki_events (
    ...
    'Coffee', 'Jo''s Coffee', '["location_visit"]', FALSE, FALSE,
...
INSERT INTO wiki_events (
    ...
    'Browsing and reading', 'Home', '["app_usage"]', FALSE, FALSE,
...
INSERT INTO wiki_events (
    ...
    'User research session', 'Office', '["calendar", "transcription"]', FALSE, FALSE,
...
INSERT INTO wiki_events (
    ...
    'Research notes', 'Office', '["app_usage"]', FALSE, FALSE,
...
INSERT INTO wiki_events (
    ...
    'Quiet evening', 'Home', '["app_usage"]', FALSE, FALSE,
...
INSERT INTO wiki_events (
    ...
    'Reading and journaling', 'Home', '["app_usage"]', FALSE, FALSE,
...
INSERT INTO wiki_events (
    ...
    'Lunch', NULL, '["location_visit"]', FALSE, FALSE,
...
('ev_b0650', 'day_2026-01-27', '2026-01-27T23:00:00Z', '2026-01-28T01:00:00Z',
 'Evening run', 'Mueller Trails', '["steps", "location_visit"]', FALSE, FALSE,
...
('ev_b0668', 'day_2026-01-29', '2026-01-29T18:30:00Z', '2026-01-29T22:30:00Z',
 'WFH afternoon', 'Home', '["app_usage", "message"]', FALSE, FALSE,
...
('ev_b0670', 'day_2026-01-29', '2026-01-30T01:00:00Z', '2026-01-30T04:00:00Z',
 'Evening wind-down', 'Home', '["app_usage"]', FALSE, FALSE,
...
('ev_b0690', 'day_2026-02-01', '2026-02-01T15:30:00Z', '2026-02-01T17:00:00Z',
 'Mueller trails run', 'Mueller Trails', '["steps", "location_visit"]', FALSE, FALSE,

 'Sunday morning run on Mueller trails, 4 miles.', '["exercise", "running", "cardio", "mueller-trails"]', '["place_demo_mueller_trails"]',
 NULL, NULL, NULL, 'NEW', 150),
('ev_b0691', 'day_2026-02-01', '2026-02-01T17:00:00Z', '2026-02-01T19:00:00Z',
 'Reading and relaxing', 'Home', '["app_usage"]', FALSE, FALSE,
...
('ev_b0692', 'day_2026-02-01', '2026-02-01T19:00:00Z', '2026-02-01T21:00:00Z',
 'Meal prep', 'Home', '["app_usage"]', FALSE, FALSE,
...
('ev_b0749', 'day_2026-02-07', '2026-02-07T19:00:00Z', '2026-02-07T21:00:00Z',
 'Afternoon reading', 'Home', '["app_usage"]', FALSE, FALSE,
...
('ev_b0768', 'day_2026-02-09', '2026-02-09T23:00:00Z', '2026-02-10T04:00:00Z',
 'Dinner and relaxing', 'Home', '["app_usage"]', FALSE, FALSE,
