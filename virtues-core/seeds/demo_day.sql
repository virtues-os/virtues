...
INSERT INTO data_location_visit (
    ...
    'lv_demo_home_morning', 'Home', 30.2851, -97.5885,
...
INSERT INTO data_location_visit (
    ...
    'lv_demo_office_am', 'Office', 30.2534, -97.6261,
...
INSERT INTO data_location_visit (
    ...
    'lv_demo_office_pm', 'Office', 30.2534, -97.6261,
...
INSERT INTO data_location_visit (
    ...
    'lv_demo_ramen', 'Ramen Tatsu-ya', 30.2562, -97.6230,
...
INSERT INTO data_location_visit (
    ...
    'lv_demo_trader_joes', 'Trader Joe''s — Seaholm', 30.2558, -97.6351,
...
INSERT INTO data_location_visit (
    ...
    'lv_demo_home_evening', 'Home', 30.2851, -97.5885,
...
INSERT INTO data_location_visit (
    ...
    'lv_demo_ladybird', 'Lady Bird Lake', 30.2477, -97.6310,
...
INSERT INTO wiki_events (
    ...
    'Bike commute from Mueller to downtown office. Listened to a Daily Stoic episode on patience. Cool morning, light traffic on the Thorne Street bike lane.', '["commute", "podcast"]', '["place_demo_home", "place_demo_office"]',
    -1.346, -0.6, 'NEW', 122
) ON CONFLICT DO NOTHING;
...
INSERT INTO wiki_events (
    ...
    'Grabbed coffee at the office kitchen, caught up on Slack threads and reviewed Mara''s Figma comments on the nav redesign.', '["messaging", "design-review"]', '["place_demo_office", "org_demo_employer", "person_demo_maya"]',
    -1.450, 0.1, 'NEW', 67
) ON CONFLICT DO NOTHING;
...
-- E07: Lunch with Mara (11:30-12:30 CST = 17:30-18:30 UTC)
INSERT INTO wiki_events (
    id, day_id, started_at, ended_at, auto_label, auto_location, source_ontologies, event_summary, topics, entities, novelty_z, autonomic_z, agent_action, avg_hr
) VALUES (
    'ev_demo_07', 'day_2026-02-13',
    '2026-02-13T17:30:00Z', '2026-02-13T18:30:00Z',
    'Lunch with Mara', 'Ramen Tatsu-ya', '["location_visit", "calendar", "transcription"]',

    'Lunch at Ramen Tatsu-ya with Mara. She''s unsure about the new hire — talked through the tradeoffs of senior vs mid-level for the open role. Also debated whether the nav redesign needs user testing before the sprint demo.', '["social", "ramen", "hiring", "team-decisions", "design"]', '["person_demo_maya", "place_demo_ramen"]',
    0.855, 1.2, 'NEW', 76
) ON CONFLICT DO NOTHING;
...
INSERT INTO wiki_events (
    ...
    'Drove from Seaholm back to Mueller with a trunk full of groceries. Recorded a short voice memo to Mara from the car: "I just bought enough snacks to survive a winter."', '["commute", "voice-memo"]', '["person_demo_maya", "place_demo_home"]',
    -0.3, -0.4, 'NEW', 68
) ON CONFLICT DO NOTHING;
...
INSERT INTO data_calendar_event (
    ...
    'Work', 'confirmed',
    'mara.vance@example.com', '["mara.vance@example.com", "david.okafor@example.com", "demo-user@example.com"]',
    NULL,
    '2026-02-13T14:15:00Z', '2026-02-13T15:00:00Z',
    'demo_cal_001', 'data_calendar_event', 'demo'
) ON CONFLICT DO NOTHING;

-- Feb 13: Lunch with Mara (11:30-12:30 CST = 17:30-18:30 UTC)
INSERT INTO data_calendar_event (
    id, title, description, calendar_name, status,
    organizer_identifier, attendee_identifiers,
    location_name,
    ...
    'Personal', 'confirmed',
    'demo-user@example.com', '["mara.vance@example.com"]',
    'Ramen Tatsu-ya',
    '2026-02-13T17:30:00Z', '2026-02-13T18:30:00Z',
...
INSERT INTO data_calendar_event (
    ...
    'Work', 'confirmed',
    'demo-user@example.com', '["participant-1@example.com", "participant-2@example.com", "participant-3@example.com"]',
    'Conference Room B',
    '2026-02-13T18:30:00Z', '2026-02-13T20:15:00Z',
...
INSERT INTO data_calendar_event (
    ...
    'Work', 'confirmed',
    'demo-user@example.com', '["david.okafor@example.com"]',
...
-- Slack: Mara re standup agenda (07:50 CST = 13:50 UTC)
INSERT INTO data_communication_message (
    ...
    'mara.vance@example.com', 'Mara Vance', '["#design-team"]',
...
INSERT INTO data_communication_message (
    ...
    'david.okafor@example.com', 'David Okafor', '["#design-team"]',
...
INSERT INTO data_communication_message (
    ...
    'demo-user@example.com', NULL, '["#design-team"]',
    TRUE, TRUE, '2026-02-13T14:05:00Z',
    'demo_msg_003', 'data_communication_message', 'demo'
) ON CONFLICT DO NOTHING;

-- Text: Cora Delgado about house (14:20 CST = 20:20 UTC)
INSERT INTO data_communication_message (
    ...
    'Hey! That Bouldin Creek house on Selden just came back on market. The one with the big backyard. Want to see it today? I can meet you at 3.',
    'cora.delgado@example.com', 'Cora Delgado', '["demo-user-sms@example.com"]',
    TRUE, FALSE, '2026-02-13T20:20:00Z',
    'demo_msg_004', 'data_communication_message', 'demo'
) ON CONFLICT DO NOTHING;

-- Text: User reply to Cora (14:22 CST = 20:22 UTC)
INSERT INTO data_communication_message (
    id, message_id, channel, body,
    from_identifier, from_name, to_identifiers,
    is_read, is_group_message, occurred_at,
    ...
    'demo-user-sms@example.com', NULL, '["cora.delgado@example.com"]',
    TRUE, FALSE, '2026-02-13T20:22:00Z',
    'demo_msg_005', 'data_communication_message', 'demo'
) ON CONFLICT DO NOTHING;

-- Text: Cora confirmation (14:25 CST = 20:25 UTC)
INSERT INTO data_communication_message (
    id, message_id, channel, body,
    from_identifier, from_name, to_identifiers,
    is_read, is_group_message, occurred_at,
    ...
    'Perfect — 1847 Selden St. I''ll be out front. You''re going to love this one.',
    'cora.delgado@example.com', 'Cora Delgado', '["demo-user-sms@example.com"]',
...
INSERT INTO data_communication_transcription (
    ...
    'txn_demo_standup',
    'Mara: Alright, let''s get going. I want to spend most of this on the onboarding flow. The drop-off data from last week is... not great.
...
Mara: That''s worse than I thought. What changed in step 3?
...
Mara: Okay, that''s two hypotheses. Field count and validation timing. Can we test both?
...
Mara: Do it. Even five minutes of signal would help. David, can you mock up a version with lazy validation? Just flag errors on blur instead of on keystroke.

David: Already on it. I''ll have a prototype in Figma by noon.

Mara: Perfect. Anything else before we wrap?

User: That''s it from me. I''ll add the onboarding task to the research session script.

Mara: Perfect. Let''s regroup tomorrow morning with the results.',
    'en', 2700,
    '2026-02-13T14:15:00Z', '2026-02-13T15:00:00Z',
    ...
    '{"people": ["Mara Vance", "David Okafor"], "topics": ["onboarding funnel", "form validation", "step 3 drop-off"], "products": ["Figma"]}',
    'demo_txn_003', 'data_communication_transcription', 'demo'
) ON CONFLICT DO NOTHING;

-- Lunch conversation with Mara at Ramen Tatsu-ya (11:30-12:30 CST = 17:30-18:30 UTC)
INSERT INTO data_communication_transcription (
    id, text, language, duration_seconds,
    started_at, ended_at,
    speaker_count, title, summary, confidence,
    ...
    'txn_demo_lunch',
    'Mara: I keep going back and forth on the new hire. On paper, Elise is perfect — great portfolio, strong systems thinking. But in the interview she kept defaulting to "it depends" on every design tradeoff question.

User: I mean, it usually does depend though.

Mara: Sure, but I wanted to see her commit to a position and defend it. You can always caveat later. I need someone who''ll push back in design reviews, not just agree with whatever the loudest voice says.

User: Fair. Did you talk to her references?

Mara: One of them said she''s "a great collaborator" which... could mean anything. The other was more specific — said she redesigned their entire settings architecture and reduced support tickets by 40 percent. That''s real impact.
...
Mara: Maybe. I have until Friday to decide. Anyway — how''s the nav redesign coming? You seemed in flow this morning.
...
Mara: Good. The tooltips-only version felt like a cop-out to me.

User: Agreed. Oh — unrelated, but Cora just texted me. That house in Bouldin Creek is back on market. The one I showed you on Zillow.

Mara: The one with the huge backyard? Go see it! Today?

User: She said 3 PM. I might duck out after the research session.

Mara: Do it. Life''s too short to miss a good house.',
    'en', 3600,
    '2026-02-13T17:30:00Z', '2026-02-13T18:30:00Z',
    2, 'Lunch with Mara — Ramen Tatsu-ya',
    'Casual lunch conversation. Mara weighing new hire decision — strong portfolio but noncommittal in interview. Discussed nav redesign progress and upcoming research session. Mentioned Bouldin Creek house coming back on market.',
    0.79,
    '["personal", "work", "lunch"]',
...
-- Voice memo to Mara from the car after Trader Joe's (5:11 PM CST = 23:11 UTC)
INSERT INTO data_communication_transcription (
    id, text, language, duration_seconds,
    started_at, ended_at,
    speaker_count, title, summary, confidence,
    ...
    'txn_demo_voice_memo',
    'Hey Mara — quick one. So I told myself I was running in for cilantro. I just bought enough snacks to survive a winter. There is a frozen mandarin chicken thing here that I have heard about for years and now I own four of them. Anyway, I''ll see you Monday.',
    'en', 22,
    '2026-02-13T23:11:00Z', '2026-02-13T23:11:22Z',
    1, 'Voice memo to Mara — Trader Joe''s haul',
    'Short voice memo sent to Mara from the car after the Seaholm Trader Joe''s detour. Self-deprecating note about over-shopping; mentions the frozen mandarin chicken specifically.',
    0.97,
    '["personal", "voice-memo", "groceries"]',
    '{"places": ["Trader Joe''s — Seaholm"], "people": ["Mara Vance"], "items": ["mandarin chicken", "cilantro"]}',
...
INSERT INTO data_financial_transaction (
    ...
    '{"location": {"city": "Austin", "region": "TX", "address": "1308 Wren St"}}'
) ON CONFLICT DO NOTHING;
...
('lp_demo_01', 30.2851, -97.5885, 5.0, '2026-02-13T13:15:00Z', 'demo_lp_001', 'data_location_point', 'demo'),
('lp_demo_02', 30.2782, -97.5950, 8.0, '2026-02-13T13:20:00Z', 'demo_lp_002', 'data_location_point', 'demo'),
('lp_demo_03', 30.2712, -97.6030, 6.0, '2026-02-13T13:25:00Z', 'demo_lp_003', 'data_location_point', 'demo'),
('lp_demo_04', 30.2642, -97.6110, 5.0, '2026-02-13T13:30:00Z', 'demo_lp_004', 'data_location_point', 'demo'),
('lp_demo_05', 30.2582, -97.6180, 7.0, '2026-02-13T13:35:00Z', 'demo_lp_005', 'data_location_point', 'demo'),
('lp_demo_06', 30.2534, -97.6261, 5.0, '2026-02-13T13:45:00Z', 'demo_lp_006', 'data_location_point', 'demo'),

-- Drive: Office → Trader Joe's Seaholm (16:00-16:12 CST = 22:00-22:12 UTC)
('lp_demo_07', 30.2534, -97.6261, 10.0, '2026-02-13T22:00:00Z', 'demo_lp_007', 'data_location_point', 'demo'),
('lp_demo_08', 30.2547, -97.6300, 12.0, '2026-02-13T22:05:00Z', 'demo_lp_008', 'data_location_point', 'demo'),
('lp_demo_09', 30.2554, -97.6330, 8.0, '2026-02-13T22:09:00Z', 'demo_lp_009', 'data_location_point', 'demo'),
('lp_demo_10', 30.2558, -97.6351, 5.0, '2026-02-13T22:12:00Z', 'demo_lp_010', 'data_location_point', 'demo'),

-- Run: Mueller trails loop (16:45-17:30 CST = 22:45-23:30 UTC)
('lp_demo_11', 30.2851, -97.5885, 4.0, '2026-02-13T22:45:00Z', 'demo_lp_011', 'data_location_point', 'demo'),
('lp_demo_12', 30.2872, -97.5860, 5.0, '2026-02-13T22:50:00Z', 'demo_lp_012', 'data_location_point', 'demo'),
('lp_demo_13', 30.2902, -97.5840, 4.0, '2026-02-13T22:55:00Z', 'demo_lp_013', 'data_location_point', 'demo'),
('lp_demo_14', 30.2922, -97.5820, 5.0, '2026-02-13T23:00:00Z', 'demo_lp_014', 'data_location_point', 'demo'),
('lp_demo_15', 30.2912, -97.5850, 4.0, '2026-02-13T23:05:00Z', 'demo_lp_015', 'data_location_point', 'demo'),
('lp_demo_16', 30.2892, -97.5870, 5.0, '2026-02-13T23:10:00Z', 'demo_lp_016', 'data_location_point', 'demo'),
('lp_demo_17', 30.2872, -97.5880, 4.0, '2026-02-13T23:15:00Z', 'demo_lp_017', 'data_location_point', 'demo'),
('lp_demo_18', 30.2857, -97.5885, 5.0, '2026-02-13T23:20:00Z', 'demo_lp_018', 'data_location_point', 'demo'),
('lp_demo_19', 30.2851, -97.5885, 4.0, '2026-02-13T23:28:00Z', 'demo_lp_019', 'data_location_point', 'demo'),

-- Drive: Trader Joe's Seaholm → Home, Mueller (17:04-17:34 CST = 23:04-23:34 UTC)
('lp_demo_j2h_01', 30.2558, -97.6351, 8.0, '2026-02-13T23:04:00Z', 'demo_lp_j2h_001', 'data_location_point', 'demo'),
('lp_demo_j2h_02', 30.2682, -97.6120, 10.0, '2026-02-13T23:18:00Z', 'demo_lp_j2h_002', 'data_location_point', 'demo'),
('lp_demo_j2h_03', 30.2851, -97.5885, 5.0, '2026-02-13T23:34:00Z', 'demo_lp_j2h_003', 'data_location_point', 'demo') ON CONFLICT DO NOTHING;
...
-- 1847 Selden St — Bouldin Creek house showing
INSERT INTO wiki_places (
    id, name, category, address,
    latitude, longitude, radius_m,
    seen_count, first_seen, last_seen,
