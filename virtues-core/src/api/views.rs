...
pub async fn list_views(pool: &PgPool, space_id: &str) -> Result<ViewListResponse> {
...
pub async fn get_view(pool: &PgPool, id: &str) -> Result<View> {
...
/// Create a new view
pub async fn create_view(pool: &PgPool, req: CreateViewRequest) -> Result<View> {
    // Validate view_type
...
pub async fn update_view(pool: &PgPool, id: &str, req: UpdateViewRequest) -> Result<View> {
...
/// Delete a view by ID
pub async fn delete_view(pool: &PgPool, id: &str) -> Result<()> {
    let existing = get_view(pool, id).await?;
...
pub async fn add_item_to_view(pool: &PgPool, view_id: &str, url: &str) -> Result<ViewItem> {
...
pub async fn list_view_items(pool: &PgPool, view_id: &str) -> Result<Vec<ViewItem>> {
...
pub async fn list_space_items(pool: &PgPool, space_id: &str) -> Result<Vec<ViewItem>> {
    let items = sqlx::query_as::<_, ViewItem>(
        r#"
        SELECT id, view_id, space_id, url, sort_order, created_at
        FROM app_space_items
...
async fn resolve_url(pool: &PgPool, url: &str) -> Result<Option<ViewEntity>> {
    // External links
    ...
    match *namespace {
        // Entity namespaces (DB-backed with IDs)
...
async fn resolve_chat_by_id(pool: &PgPool, id: &str) -> Result<Option<ViewEntity>> {
...
async fn resolve_page_by_id(pool: &PgPool, id: &str) -> Result<Option<ViewEntity>> {
...
async fn resolve_person_by_id(pool: &PgPool, id: &str) -> Result<Option<ViewEntity>> {
    let result = sqlx::query_as::<_, (String, String)>(
...
async fn resolve_place_by_id(pool: &PgPool, id: &str) -> Result<Option<ViewEntity>> {
    let result =
...
async fn resolve_org_by_id(pool: &PgPool, id: &str) -> Result<Option<ViewEntity>> {
    let result = sqlx::query_as::<_, (String, String)>(
...
async fn resolve_thing_by_id(pool: &PgPool, id: &str) -> Result<Option<ViewEntity>> {
    let result = sqlx::query_as::<_, (String, String)>(
...
async fn resolve_day_by_id(pool: &PgPool, id: &str) -> Result<Option<ViewEntity>> {
    let result =
...
async fn resolve_year_by_id(pool: &PgPool, id: &str) -> Result<Option<ViewEntity>> {
    let result =
...
async fn resolve_source_by_id(pool: &PgPool, id: &str) -> Result<Option<ViewEntity>> {
    let result = sqlx::query_as::<_, (String, String)>(
...
async fn resolve_view_by_id(pool: &PgPool, id: &str) -> Result<Option<ViewEntity>> {
